...
const BookingBanner = () => {
  return (
    <div className="relative bg-gradient-to-br from-emerald-50 to-teal-100 min-h-screen flex items-center overflow-hidden">
      {/* Background Shapes */}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start space-x-4">
              <button className="flex items-center bg-gradient-to-r from-green-500 to-teal-400 text-white px-6 py-3 rounded-full hover:scale-105 transition-transform group">
            ...
            <div className="flex space-x-4 justify-center lg:justify-start">
              <div className="flex items-center bg-white/50 backdrop-blur-sm p-2 rounded-lg">
                <Leaf className="text-green-600 mr-2" />
                <span className="text-sm text-gray-700">Instant Cash</span>
              </div>
              <div className="flex items-center bg-white/50 backdrop-blur-sm p-2 rounded-lg">
