...
const PriceCard = ({ title, rate, note, imgSrc }) => (
  <div className="relative group p-4 bg-white rounded-lg w-full shadow-md hover:shadow-lg transition-all duration-300 border-2 border-[#cae4c7] mb-4">
    {imgSrc && (
      <img src={imagerate} alt={title} className="w-full h-40 object-cover rounded-md mb-3" />
    )}
...
const CategorySection = ({ title, items }) => (
  <div className="mb-8">
    <h2 className="text-2xl font-bold text-[#335230] mb-4 border-b-2 border-[#cae4c7] pb-2">
      {title}
    </h2>
    ...
    paper: {
      ...
      items: [
        ...
        { title: 'Copies/Books', rate: '12/kg' },
        {
          title: 'Cardboard',
          rate: '8/kg',
          note: 'To get quote for bulk qty. call at +91-44-9099-2355',
        },
      ],
    },
    metals: {
    ...
    others: {
      ...
      items: [
        { title: 'Bike', rate: '2100/piece' },
        {
          title: 'Clothes',
          rate: '2/kg',
          note: "Accepted only when given with other scrap items (We don't accept undergarments)",
        },
        {
          title: 'Glass Bottles',
          rate: '2/kg',
          note: 'Accepted only when given with other scrap items',
        },
    ...
    <div>
      ...
      <div className="relative min-h-screen bg-gray-50 py-2 px-4">
        ...
        <div className="relative container mx-auto z-10">
          <h1 className="text-4xl font-bold text-center text-[#335230] mb-12">
            Current Scrap Rates
          </h1>
