  ...
  const CustomEvent = ({ event }) => {
    ...
    return (
      <div className="group relative">
        <div
          className={`w-full h-2 ${statusColors[event.status]} rounded-lg`}
        />
    ...
    <div className="w-full">
      ...
      <div className="bg-white min-h-screen relative">
        ...
        <button
          ...
          className="fixed bottom-8 right-3 bg-[#4DA674] text-white px-6 py-4 rounded-full shadow-lg hover:bg-green-600 text-xl font-extrabold transition-colors"
        >
          +
        </button>
      </div>
