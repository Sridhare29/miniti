    ...
    <div className="relative min-h-[40vh] w-full bg-[#ffffff] overflow-hidden px-6 sm:px-10 lg:px-16 py-10">
      ...
      <div className="relative container mx-auto flex flex-col items-center justify-center text-center z-10">
        <div className="text-[#335230] space-y-4">
          {/* First Line */}
          <h2 className="text-4xl lg:text-6xl font-bold animate-fade-in">Our Services</h2>

          {/* Second Line */}
          <p className="text-2xl lg:text-3xl italic">
            We offer comprehensive scrap collection services for households and corporate entities.
            Our services include the collection of electronic waste, metal scrap, plastic waste, and
            paper waste. All materials are responsibly recycled and disposed of with care for the
            environment.
          </p>
